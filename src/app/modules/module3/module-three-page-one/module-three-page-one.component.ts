...
@Component({
  selector: 'app-module-three-page-one',
  templateUrl: './module-three-page-one.component.html',
  styleUrls: ['./module-three-page-one.component.scss']
})
export class ModuleThreePageOneComponent implements OnInit {
  firstPage = 0;
  secondPage = 0;
  thirdPage = 0;
  fourthPage = 0;
