...
@Component({
  selector: 'app-module-three-page-three',
  templateUrl: './module-three-page-three.component.html',
  styleUrls: ['./module-three-page-three.component.scss']
})
export class ModuleThreePageThreeComponent implements OnInit {
  firstPage = 0;
  secondPage = 0;
  thirdPage = 0;
  fourthPage = 0;
