...
@Component({
  selector: 'app-module-three-page-two',
  templateUrl: './module-three-page-two.component.html',
  styleUrls: ['./module-three-page-two.component.scss']
})
export class ModuleThreePageTwoComponent implements OnInit {
  firstPage = 0;
  secondPage = 0;
  thirdPage = 0;
  fourthPage = 0;
