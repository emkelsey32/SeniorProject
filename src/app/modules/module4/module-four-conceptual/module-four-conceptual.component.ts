...
@Component({
  selector: 'app-module-four-conceptual',
  templateUrl: './module-four-conceptual.component.html',
  styleUrls: ['./module-four-conceptual.component.scss']
})
export class ModuleFourConceptualComponent implements OnInit {
  firstPage = 0;
  secondPage = 0;
  thirdPage = 0;
  fourthPage = 0;
