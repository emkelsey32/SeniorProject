...
@Component({
  selector: 'app-module-four-page-five',
  templateUrl: './module-four-page-five.component.html',
  styleUrls: ['./module-four-page-five.component.scss']
})
export class ModuleFourPageFiveComponent implements OnInit {
  firstPage = 0;
  secondPage = 0;
  thirdPage = 0;
  fourthPage = 0;
