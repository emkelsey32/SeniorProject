...
@Component({
  selector: 'app-module-four-page-four',
  templateUrl: './module-four-page-four.component.html',
  styleUrls: ['./module-four-page-four.component.scss']
})
export class ModuleFourPageFourComponent implements OnInit {
  firstPage = 0;
  secondPage = 0;
  thirdPage = 0;
  fourthPage = 0;
