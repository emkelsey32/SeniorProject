...
@Component({
  selector: 'app-module-four-page-one',
  templateUrl: './module-four-page-one.component.html',
  styleUrls: ['./module-four-page-one.component.scss']
})
export class ModuleFourPageOneComponent implements OnInit {
  firstPage = 0;
  secondPage = 0;
  thirdPage = 0;
  fourthPage = 0;
