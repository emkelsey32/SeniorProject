...
@Component({
  selector: 'app-module-four-page-three',
  templateUrl: './module-four-page-three.component.html',
  styleUrls: ['./module-four-page-three.component.scss']
})
export class ModuleFourPageThreeComponent implements OnInit {
  firstPage = 0;
  secondPage = 0;
  thirdPage = 0;
  fourthPage = 0;
