...
@Component({
  selector: 'app-module-four-page-two',
  templateUrl: './module-four-page-two.component.html',
  styleUrls: ['./module-four-page-two.component.scss']
})
export class ModuleFourPageTwoComponent implements OnInit {
  firstPage = 0;
  secondPage = 0;
  thirdPage = 0;
  fourthPage = 0;
