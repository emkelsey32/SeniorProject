...
@Component({
  selector: 'app-module-five-page-five',
  templateUrl: './module-five-page-five.component.html',
  styleUrls: ['./module-five-page-five.component.scss']
})
export class ModuleFivePageFiveComponent implements OnInit {
  firstPage = 0;
  secondPage = 0;
  thirdPage = 0;
  fourthPage = 0;
