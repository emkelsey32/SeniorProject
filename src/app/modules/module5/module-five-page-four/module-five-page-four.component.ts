...
@Component({
  selector: 'app-module-five-page-four',
  templateUrl: './module-five-page-four.component.html',
  styleUrls: ['./module-five-page-four.component.scss']
})
export class ModuleFivePageFourComponent implements OnInit {
  firstPage = 0;
  secondPage = 0;
  thirdPage = 0;
  fourthPage = 0;
