...
@Component({
  selector: 'app-module-five-page-one',
  templateUrl: './module-five-page-one.component.html',
  styleUrls: ['./module-five-page-one.component.scss']
})
export class ModuleFivePageOneComponent implements OnInit {
  firstPage = 0;
  secondPage = 0;
  thirdPage = 0;
  fourthPage = 0;
