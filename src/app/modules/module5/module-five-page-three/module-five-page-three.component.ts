...
@Component({
  selector: 'app-module-five-page-three',
  templateUrl: './module-five-page-three.component.html',
  styleUrls: ['./module-five-page-three.component.scss']
})
export class ModuleFivePageThreeComponent implements OnInit {
  firstPage = 0;
  secondPage = 0;
  thirdPage = 0;
  fourthPage = 0;
