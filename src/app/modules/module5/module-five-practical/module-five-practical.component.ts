...
@Component({
  selector: 'app-module-five-practical',
  templateUrl: './module-five-practical.component.html',
  styleUrls: ['./module-five-practical.component.scss']
})
export class ModuleFivePracticalComponent implements OnInit {
  firstPage = 0;
  secondPage = 0;
  thirdPage = 0;
  fourthPage = 0;
